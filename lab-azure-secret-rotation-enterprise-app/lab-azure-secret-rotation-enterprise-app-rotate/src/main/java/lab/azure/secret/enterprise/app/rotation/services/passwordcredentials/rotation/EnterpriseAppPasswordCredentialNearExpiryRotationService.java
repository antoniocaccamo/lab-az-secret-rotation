...
@ApplicationScoped
public class EnterpriseAppPasswordCredentialNearExpiryRotationService extends AbstractPasswordCredentialRotationService {

    protected static final String TemplatePath = "email/EnterpriseApp.PasswordCredentialNearExpiry.ftl";
    ...
    public EnterpriseAppPasswordCredentialNearExpiryRotationService() {
        super(EnterpriseAppEventEnum.PasswordCredentialNearExpiry);
    }
