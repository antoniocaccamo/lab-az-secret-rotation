...
@QuarkusTest @Slf4j
class EnterpriseAppPasswordCredentialNearExpiringRotationServiceTest {

    private static final String EVENT_PATH = "events/password.credential.near.expiry.json";
    ...
    @Inject @EnterpriseAppPasswordCredentialNearExpiry
    ...
    @Test @Order(1)
    public void when_event_then_ok() {
        ...
        Assertions.assertEquals(EnterpriseAppEventEnum.PasswordCredentialNearExpiry, event.getEnterpriseAppEventEnum());
